...
#загрузка иконок
game_screen = pygame.image.load('Images/space_game_screen.jpg')
alien_boo = pygame.image.load('Images/aliens_boo.png')
my_ship = pygame.image.load('Images/our_sheep.png')
asteroid50 = pygame.image.load('Images/asteroid_50.png')
asteroid100 = pygame.image.load('Images/asteroid_100.png')
